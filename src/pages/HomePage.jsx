    ...
    <div className="mb-20">
      ...
      <div className="flex flex-col lg:flex-row px-4 sm:px-8 lg:px-20 gap-6">
        ...
        <div
          ...
          } lg:block lg:w-64 flex-shrink-0 lg:static fixed lg:relative top-0 left-0 h-full lg:h-auto bg-white lg:bg-transparent z-50 lg:z-auto overflow-y-auto lg:overflow-visible p-4 lg:p-0 shadow-lg lg:shadow-none`}
        >
          <Sidebar onFiltersChange={handleFiltersChange} />
        </div>
