          ...
          <div className="bg-white py-4 sm:py-6 px-4 sm:px-6 lg:px-10 rounded-xl w-full max-w-[700px] max-h-[90vh] overflow-y-auto shadow-lg">
            ...
            <div className="space-y-4 sm:space-y-5">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start gap-2 sm:gap-4">
                ...
                <div className="flex-1 space-y-3">
                  {variants.map((variant, idx) => (
                    <div key={idx} className="space-y-3 sm:space-y-0 sm:flex sm:items-center sm:gap-4 p-3 border rounded-lg sm:border-none sm:p-0">
                      {/* RAM */}
                      <div className="flex items-center gap-2">
                        <label className="text-[#3C3C3C73] text-sm min-w-[30px]">Ram:</label>
                        <input
                          type="text"
                          placeholder="RAM"
                          value={variant.ram}
                      ...
                      {/* Quantity with < > style */}
                      <div className="flex items-center gap-2">
                        <label className="text-[#3C3C3C73] text-sm min-w-[30px]">QTY:</label>
                        <div className="flex items-center border border-gray-300 rounded-md px-2 py-1">
                          <button
                            type="button"
                            onClick={() => {
